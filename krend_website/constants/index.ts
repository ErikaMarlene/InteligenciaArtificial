...
export const BldgTypeOptions = [
  ...
  { title: "Townhouse End Unit", value: "=TwnhsE" },
  { title: "Townhouse Inside Unit", value: "=TwnhsI" }
];
...
export const HouseStyleOptions = [
  ...
  { title: "Two story", value: "=2Story" },
  { title: "Two and one-half story: 2nd level finished", value: "=2.5Fin" },
  { title: "Two and one-half story: 2nd level unfinished", value: "=2.5Unf" },
  { title: "Split Foyer", value: "=SFoyer" },
  { title: "Split Level", value: "=SLvl" }
];
...
export const RoofMatlOptions = [
  ...
  { title: "Gravel & Tar", value: "=Tar&Grv" },
  { title: "Wood Shakes", value: "=WdShake" },
  { title: "Wood Shingles", value: "=WdShngl" }
];
...
export const Exterior1stOptions = [
  ...
  { title: "Cement Board", value: "=CemntBd" },
  { title: "Hard Board", value: "=HdBoard" },
  { title: "Imitation Stucco", value: "=ImStucc" },
  { title: "Metal Siding", value: "=MetalSd" },
  { title: "Other", value: "=Other" },
  { title: "Plywood", value: "=Plywood" },
  { title: "PreCast", value: "=PreCast" },
  { title: "Stone", value: "=Stone" },
  { title: "Stucco", value: "=Stucco" },
  { title: "Vinyl Siding", value: "=VinylSd" },
  { title: "Wood Siding", value: "=Wd Sdng" },
  { title: "Wood Shingles", value: "=WdShing" }
];
...
export const BsmtQualOptions = [
  ...
  { title: "Fair (70-79 inches)", value: "=Fa" },
  { title: "Poor (<70 inches)", value: "=Po" },
...
export const BsmtCondOptions = [
  ...
  { title: "Fair - dampness or some cracking or settling", value: "=Fa" },
  { title: "Poor - Severe cracking, settling, or wetness", value: "=Po" },
  { title: "No Basement", value: "=NA" }
];
...
export const BsmtFinType1Options = [
  ...
  { title: "Average Rec Room", value: "=Rec" },
  { title: "Low Quality", value: "=LwQ" },
...
export const ElectricalOptions = [
  ...
  { title: "60 AMP Fuse Box and mostly knob & tube wiring (poor)", value: "=FuseP" },
...
export const FunctionalOptions = [
  ...
  { title: "Moderate Deductions", value: "=Mod" },
  { title: "Major Deductions 1", value: "=Maj1" },
  { title: "Major Deductions 2", value: "=Maj2" },
  { title: "Severely Damaged", value: "=Sev" },
  { title: "Salvage only", value: "=Sal" }
];
...
export const FireplaceQuOptions = [
  ...
  { title: "Fair - Prefabricated Fireplace in basement", value: "=Fa" },
  { title: "Poor - Ben Franklin Stove", value: "=Po" },
  { title: "No Fireplace", value: "=NA" }
];
...
export const GarageTypeOptions = [
  ...
  { title: "Car Port", value: "=CarPort" },
  { title: "Detchd", value: "=Detchd" },
  { title: "No Garage", value: "=NA" }
];
...
export const FenceOptions = [
  ...
  { title: "Minimum Wood/Wire", value: "=MnWw" },
  { title: "No Fence", value: "=NA" }
];
...
export const SaleTypeOptions = [
  ...
  { title: "Contract", value: "=CWD" },
  { title: "New", value: "=New" },
  { title: "Partial", value: "=Partial" },
  { title: "Other", value: "=Oth" }
];
...
export const SaleConditionOptions = [
  ...
  { title: "Family Sale", value: "=Family" },
  { title: "Normal Sale", value: "=Normal" },
  { title: "Partial Sale - not included in total price", value: "=Partial" }
];
